...
if __name__ == '__main__':
    ...
    config_file="dpd_driver_punish_config.ini"
    ...
    try:
        ...
        for write_filenames in read_txt(os_path,str(para_name['condition']['list_name'])+".txt"):
            ...
            data_info=read_excel(para_name['base']['input_path'], para_name['base']['file_name'],para_name['base']['sheet_no'],para_name['base']['title_no'],para_name['base']['order_list'])  #读取excel数据
